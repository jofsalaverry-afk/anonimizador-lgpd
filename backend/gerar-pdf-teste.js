...
async function main() {
  ...
  const linhas = [
    ...
    ['', font, 11],
    ['CONTRATADA: Tech Solucoes LTDA, CNPJ 98.765.432/0001-10, com sede na', font, 11],
    ['Avenida Paulista, 1000, Bela Vista, Sao Paulo/SP, CEP 01310-100,', font, 11],
    ...
    ['cuja responsavel tecnica (CPF 990.477.050-68) atuara como consultora', font, 11],
    ['e o fiscal do contrato (CPF 723.271.039-91) acompanhara a execucao.', font, 11],
    ['', font, 11],
